...
the lowest active open node is `S086`, receipt line-box checksum field, after generated fixture
glyph-run receipt checksums were hardened in TypeScript and Rust.
