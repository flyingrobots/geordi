...
the lowest active open node is `S089`, multiline rejection fixture, after the committed fallback
chain text-prep fixture became part of the rejection corpus.
